...
void TypeLibLoader::Load( const Nan::FunctionCallbackInfo< v8::Value >& info )
{
	...
	v8::String::Utf8Value utf8( v8::Isolate::GetCurrent(),info[ 0 ]->ToString(Nan::GetCurrentContext()).ToLocalChecked() );
...
void TypeLibLoader::Init( v8::Local< v8::Object > exports )
{
	...
	exports->Set(Nan::GetCurrentContext(), Nan::New( "load" ).ToLocalChecked(), load->GetFunction(Nan::GetCurrentContext()).ToLocalChecked() );
}
