...
void InitVariant( ITypeInfo* typeInfo, const TYPEDESC& typedesc, v8::Local< v8::Value > value, OUT CComVariant& variant )
{
	...
	case VT_I1:  //signed char
		variant.cVal = static_cast< char >( value->Int32Value(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_UI1:  //unsigned char
		variant.bVal = static_cast< unsigned char >( value->Int32Value(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_I2:  //2 byte signed int
		variant.iVal = static_cast< SHORT >( value->Int32Value(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_UI2:  //unsigned short
		variant.uiVal = static_cast< USHORT >( value->Int32Value(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_I4:  //4 byte signed int
		variant.lVal = static_cast< LONG >( value->Int32Value(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_UI4:  //ULONG
		variant.ulVal = static_cast< ULONG >( value->Int32Value(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_I8:  //signed 64-bit int
		variant.llVal = static_cast< LONGLONG >( value->IntegerValue(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_UI8:  //unsigned 64-bit int
		variant.ullVal = static_cast< ULONGLONG >( value->IntegerValue(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_INT:  //signed machine int
		variant.intVal = static_cast< INT >( value->Int32Value(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_UINT:  //unsigned machine int
		variant.uintVal = static_cast< UINT >( value->Int32Value(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_R4:  //4 byte real
		variant.fltVal = static_cast< float >( value->NumberValue(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_R8:  //8 byte real
		variant.dblVal = static_cast< double >( value->NumberValue(Nan::GetCurrentContext()).FromJust() );
		break;
	case VT_DATE:  //date
	{
	...
	{
		v8::String::Utf8Value utf8( v8::Isolate::GetCurrent(),value->ToString(Nan::GetCurrentContext()).ToLocalChecked() );
	...
	case VT_BOOL:  //True=-1, False=0
		variant.boolVal = value->ToBoolean(v8::Isolate::GetCurrent())->BooleanValue(v8::Isolate::GetCurrent()) ? VARIANT_TRUE : VARIANT_FALSE;
		break;
...
void InitVariantEnum( ITypeInfo* typeInfo, v8::Local< v8::Value > value, OUT CComVariant& variant )
{
	int numValue;
	if( value->IsNumber() )
		numValue = value->Int32Value(Nan::GetCurrentContext()).FromJust();
